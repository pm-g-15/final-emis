...
export const particularMonthYear = (year, month) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API_URL}/api/teachers/allincome/${year}/${month}`
    );
    dispatch({
...
export const particularYear = (year, month) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API_URL}/api/teachers/allincome/${year}`
    );
    dispatch({
      type: ALL_INCOME_SUCCESS,
      payload: data,
...
export const alltillNow = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API_URL}/api/teachers/allincome`
    );
    dispatch({
      type: ALL_INCOME_SUCCESS,
      payload: data,
...
export const particularMonthYearSalary = (year, month) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API_URL}/api/teachers/allsalary/${year}/${month}`
    );
    dispatch({
...
export const particularYearSalary = (year) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API_URL}/api/teachers/allsalary/${year}`
    );
    dispatch({
      type: ALL_SALARY_SUCCESS,
      payload: data,
...
export const alltillNowSalary = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API_URL}/api/teachers/allsalaries`
    );
