...
export const classlistStudent = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API_URL}/api/students/class/${id}`
    );
    dispatch({
...
export const studentSearch = (name, classname, rollno) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API_URL}/api/students/search/${name}/${classname}/${rollno}`
    );
...
export const deleteStudent = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(
      `${process.env.REACT_APP_API_URL}/api/students/delete/${id}`
    );
    dispatch({
...
export const studentAttendances =
  (classname, students) => async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.post(
        `${process.env.REACT_APP_API_URL}/api/students/attendance/${classname}`,
        {
          students,
        },
        config
...
export const PayFees =
  ...
  async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.post(
        `${process.env.REACT_APP_API_URL}/api/students/fees/${studentId}`,
        {
          student_name,
          classname,
          roll_no,
