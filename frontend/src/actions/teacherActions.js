  ...
  async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.post(
        `${process.env.REACT_APP_API_URL}/api/teachers/fees/${teachername}/${teacherid}`,
        {
          salaryForTheYear,
          salaryForTheMonth,
          salaryAmount,
...
export const teacherregister =
  ...
  async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.post(
        `${process.env.REACT_APP_API_URL}/api/teachers/register`,
        {
          teacher_name,
...
export const deleteTeacher = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(
      `${process.env.REACT_APP_API_URL}/api/teachers/delete/${id}`
    );
    dispatch({
